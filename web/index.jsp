        ...
        <div id="visual">
            <div class="slide-visual">
                <ul class="slide-group">
                    <li><img class="img-responsive" src="images/a1.jpg" alt="Dummy Image" /></li>
                    <li><img class="img-responsive" src="images/a12.jpg" alt="Dummy Image" /></li>
                    <li><img class="img-responsive" src="images/aee3.jpg" alt="Dummy Image" /></li>
